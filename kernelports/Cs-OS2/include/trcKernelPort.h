...
#define OS_TRACE_MBOX_POST(p_event) \
    xTraceEventCreate1(PSF_EVENT_MBOX_POST, (TraceUnsignedBaseType_t)p_event);

#undef OS_TRACE_MBOX_POST_FAILED
#define OS_TRACE_MBOX_POST_FAILED(p_event) \
    xTraceEventCreate1(PSF_EVENT_MBOX_POST_FAILED, (TraceUnsignedBaseType_t)p_event);

#undef OS_TRACE_MBOX_PEND
#define OS_TRACE_MBOX_PEND(p_event) \
    xTraceEventCreate1(PSF_EVENT_MBOX_PEND, (TraceUnsignedBaseType_t)p_event);

#undef OS_TRACE_MBOX_PEND_FAILED
#define OS_TRACE_MBOX_PEND_FAILED(p_event) \
    xTraceEventCreate1(PSF_EVENT_MBOX_PEND_FAILED, (TraceUnsignedBaseType_t)p_event);

#undef OS_TRACE_MBOX_PEND_BLOCK
#define OS_TRACE_MBOX_PEND_BLOCK(p_event) \
    xTraceEventCreate1(PSF_EVENT_MBOX_PEND_BLOCK, (TraceUnsignedBaseType_t)p_event);

#if (OS_TRACE_API_ENTER_EN == 1u)
#undef OS_TRACE_MBOX_DEL_ENTER
#define OS_TRACE_MBOX_DEL_ENTER(p_event, opt) \
    xTraceEventCreate2(PSF_EVENT_MBOX_DEL_ENTER, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_MBOX_POST_ENTER
#define OS_TRACE_MBOX_POST_ENTER(p_event) \
    xTraceEventCreate1(PSF_EVENT_MBOX_POST_ENTER, (TraceUnsignedBaseType_t)p_event);

#undef OS_TRACE_MBOX_POST_OPT_ENTER
#define OS_TRACE_MBOX_POST_OPT_ENTER(p_event, opt) \
    xTraceEventCreate2(PSF_EVENT_MBOX_POST_OPT_ENTER, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_MBOX_PEND_ENTER
#define OS_TRACE_MBOX_PEND_ENTER(p_event, timeout) \
    xTraceEventCreate2(PSF_EVENT_MBOX_PEND_ENTER, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)timeout);
#endif
...
#define OS_TRACE_MBOX_DEL_EXIT(p_event, err) \
    if (err != OS_ERR_NONE) { \
        xTraceEventCreate2(PSF_EVENT_MBOX_DEL_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err); \
    }

#undef OS_TRACE_MBOX_POST_EXIT
#define OS_TRACE_MBOX_POST_EXIT(p_event, err) \
    xTraceEventCreate2(PSF_EVENT_MBOX_POST_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_MBOX_POST_OPT_EXIT
#define OS_TRACE_MBOX_POST_OPT_EXIT(p_event, err) \
    xTraceEventCreate2(PSF_EVENT_MBOX_POST_OPT_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_MBOX_PEND_EXIT
#define OS_TRACE_MBOX_PEND_EXIT(p_event, err) \
    xTraceEventCreate2(PSF_EVENT_MBOX_PEND_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err);
#endif
...
#define OS_TRACE_MEM_CREATE(p_mem) \
    xTraceObjectRegisterWithoutHandle(PSF_EVENT_MEM_CREATE, p_mem, 0, (TraceUnsignedBaseType_t)(p_mem->OSMemNBlks));
...
#define OS_TRACE_MUTEX_POST(p_event) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_POST, (TraceUnsignedBaseType_t)p_event);
...
#define OS_TRACE_MUTEX_POST_FAILED(p_event) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_POST_FAILED, (TraceUnsignedBaseType_t)p_event);

/* Called when a signal is received from a mutex */
/* No need to protect critical section. */
#undef OS_TRACE_MUTEX_PEND
#define OS_TRACE_MUTEX_PEND(p_event) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_PEND, (TraceUnsignedBaseType_t)p_event);

/* Called when a signal is received from a mutex */
/* No need to protect critical section. */
#undef OS_TRACE_MUTEX_PEND_FAILED
#define OS_TRACE_MUTEX_PEND_FAILED(p_event) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_PEND_FAILED, (TraceUnsignedBaseType_t)p_event);

/* Called when a signal is received from a mutex */
/* No need to protect critical section. */
#undef OS_TRACE_MUTEX_PEND_BLOCK
#define OS_TRACE_MUTEX_PEND_BLOCK(p_event) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_PEND_BLOCK, (TraceUnsignedBaseType_t)p_event);
...
#define OS_TRACE_MUTEX_DEL_ENTER(p_event, opt) \
	xTraceEventCreate2(PSF_EVENT_MUTEX_DEL_ENTER, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_MUTEX_POST_ENTER
#define OS_TRACE_MUTEX_POST_ENTER(p_event) \
	xTraceEventCreate1(PSF_EVENT_MUTEX_POST_ENTER, (TraceUnsignedBaseType_t)p_event);

#undef OS_TRACE_MUTEX_PEND_ENTER
#define OS_TRACE_MUTEX_PEND_ENTER(p_event, timeout) \
	xTraceEventCreate2(PSF_EVENT_MUTEX_PEND_ENTER, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)timeout);
#endif
...
#define OS_TRACE_MUTEX_DEL_EXIT(p_event, err) \
    if (err != OS_ERR_NONE) { \
        xTraceEventCreate2(PSF_EVENT_MUTEX_DEL_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err); \
    }

#undef OS_TRACE_MUTEX_POST_EXIT
#define OS_TRACE_MUTEX_POST_EXIT(p_event, err) \
	xTraceEventCreate2(PSF_EVENT_MUTEX_POST_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_MUTEX_PEND_EXIT
#define OS_TRACE_MUTEX_PEND_EXIT(p_event, err) \
	xTraceEventCreate2(PSF_EVENT_MUTEX_PEND_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err);
#endif
...
#define OS_TRACE_Q_POST(p_event)  \
    xTraceEventCreate2(PSF_EVENT_Q_POST, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(((OS_Q *)p_event->OSEventPtr)->OSQEntries));
...
#define OS_TRACE_Q_POST_FAILED(p_event) \
    xTraceEventCreate2(PSF_EVENT_Q_POST_FAILED, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(((OS_Q *)p_event->OSEventPtr)->OSQEntries));

/* Called when a signal is sent to a queue */
/* No need to protect critical section. */
#undef OS_TRACE_Q_POST_FRONT
#define OS_TRACE_Q_POST_FRONT(p_event)  \
    xTraceEventCreate2(PSF_EVENT_Q_POST_FRONT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(((OS_Q *)p_event->OSEventPtr)->OSQEntries));

/* Called when a signal is sent to a queue */
/* No need to protect critical section. */
#undef OS_TRACE_Q_POST_FRONT_FAILED
#define OS_TRACE_Q_POST_FRONT_FAILED(p_event)  \
    xTraceEventCreate2(PSF_EVENT_Q_POST_FRONT_FAILED, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(((OS_Q *)p_event->OSEventPtr)->OSQEntries));
...
#define OS_TRACE_Q_PEND(p_event) \
    xTraceEventCreate2(PSF_EVENT_Q_PEND, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(((OS_Q *)p_event->OSEventPtr)->OSQEntries));

/* Called when a message is received from a queue */
/* No need to protect critical section. */
#undef OS_TRACE_Q_PEND_FAILED
#define OS_TRACE_Q_PEND_FAILED(p_event) \
    xTraceEventCreate2(PSF_EVENT_Q_PEND_FAILED, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(((OS_Q *)p_event->OSEventPtr)->OSQEntries));

/* Called when a message is received from a queue */
/* No need to protect critical section. */
#undef OS_TRACE_Q_PEND_BLOCK
#define OS_TRACE_Q_PEND_BLOCK(p_event) \
    xTraceEventCreate2(PSF_EVENT_Q_PEND_BLOCK, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(((OS_Q *)p_event->OSEventPtr)->OSQEntries));

/* Called when the queue is flushed */
/* No need to protect critical section. */
#undef OS_TRACE_Q_FLUSH
#define OS_TRACE_Q_FLUSH(p_event) \
    xTraceEventCreate2(PSF_EVENT_Q_FLUSH, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(((OS_Q *)p_event->OSEventPtr)->OSQEntries));

#if (OS_TRACE_API_ENTER_EN == 1u)
#undef OS_TRACE_Q_DEL_ENTER
#define OS_TRACE_Q_DEL_ENTER(p_event, opt) \
	xTraceEventCreate2(PSF_EVENT_Q_DEL_ENTER, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_Q_POST_ENTER
#define OS_TRACE_Q_POST_ENTER(p_event) \
	xTraceEventCreate1(PSF_EVENT_Q_POST_ENTER, (TraceUnsignedBaseType_t)p_event);

#undef OS_TRACE_Q_POST_FRONT_ENTER
#define OS_TRACE_Q_POST_FRONT_ENTER(p_event) \
	xTraceEventCreate1(PSF_EVENT_Q_POST_FRONT_ENTER, (TraceUnsignedBaseType_t)p_event);

#undef OS_TRACE_Q_POST_OPT_ENTER
#define OS_TRACE_Q_POST_OPT_ENTER(p_event, opt) \
	xTraceEventCreate2(PSF_EVENT_Q_POST_OPT_ENTER, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_Q_PEND_ENTER
#define OS_TRACE_Q_PEND_ENTER(p_event, timeout) \
	xTraceEventCreate2(PSF_EVENT_Q_PEND_ENTER, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)timeout);
#endif
...
#define OS_TRACE_Q_DEL_EXIT(p_event, err) \
    if (err != OS_ERR_NONE) { \
    	xTraceEventCreate2(PSF_EVENT_Q_DEL_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err); \
    }

#undef OS_TRACE_Q_POST_EXIT
#define OS_TRACE_Q_POST_EXIT(p_event, err) \
	xTraceEventCreate2(PSF_EVENT_Q_POST_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_Q_POST_FRONT_EXIT
#define OS_TRACE_Q_POST_FRONT_EXIT(p_event, err) \
	xTraceEventCreate2(PSF_EVENT_Q_POST_FRONT_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_Q_POST_OPT_EXIT
#define OS_TRACE_Q_POST_OPT_EXIT(p_event, err) \
	xTraceEventCreate2(PSF_EVENT_Q_POST_OPT_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_Q_PEND_EXIT
#define OS_TRACE_Q_PEND_EXIT(p_event, err) \
	xTraceEventCreate2(PSF_EVENT_Q_PEND_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err);
#endif
...
#define OS_TRACE_SEM_POST(p_event) \
    xTraceEventCreate2(PSF_EVENT_SEM_POST, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(p_event->OSEventCnt));
...
#define OS_TRACE_SEM_POST_FAILED(p_event) \
    xTraceEventCreate2(PSF_EVENT_SEM_POST_FAILED, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(p_event->OSEventCnt));

/* Called when a message is received from a semaphore */
/* No need to protect critical section. */
#undef OS_TRACE_SEM_PEND
#define OS_TRACE_SEM_PEND(p_event) \
    xTraceEventCreate2(PSF_EVENT_SEM_PEND, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(p_event->OSEventCnt));

/* Called when a message is received from a semaphore */
/* No need to protect critical section. */
#undef OS_TRACE_SEM_PEND_FAILED
#define OS_TRACE_SEM_PEND_FAILED(p_event) \
    xTraceEventCreate2(PSF_EVENT_SEM_PEND_FAILED, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(p_event->OSEventCnt));

/* Called when a message is received from a semaphore */
/* No need to protect critical section. */
#undef OS_TRACE_SEM_PEND_BLOCK
#define OS_TRACE_SEM_PEND_BLOCK(p_event) \
    xTraceEventCreate2(PSF_EVENT_SEM_PEND_BLOCK, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(p_event->OSEventCnt));

/* Called from OSSemAccept. */
/* No need to protect critical section. */
#undef OS_TRACE_SEM_ACCEPT
#define OS_TRACE_SEM_ACCEPT(p_event) \
    xTraceEventCreate2(PSF_EVENT_SEM_ACCEPT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(p_event->OSEventCnt));

/* Called when setting the semaphore to a specified value */
/* No need to protect critical section. */
#undef OS_TRACE_SEM_SET
#define OS_TRACE_SEM_SET(p_event) \
    xTraceEventCreate2(PSF_EVENT_SEM_SET, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(p_event->OSEventCnt));

/* Called when setting the semaphore to a specified value */
/* No need to protect critical section. */
#undef OS_TRACE_SEM_SET_FAILED
#define OS_TRACE_SEM_SET_FAILED(p_event) \
    xTraceEventCreate2(PSF_EVENT_SEM_SET_FAILED, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)(p_event->OSEventCnt));

#if (OS_TRACE_API_ENTER_EN == 1u)
#undef OS_TRACE_SEM_DEL_ENTER
#define OS_TRACE_SEM_DEL_ENTER(p_event, opt) \
	xTraceEventCreate2(PSF_EVENT_SEM_DEL_ENTER, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_SEM_POST_ENTER
#define OS_TRACE_SEM_POST_ENTER(p_event) \
	xTraceEventCreate1(PSF_EVENT_SEM_POST_ENTER, (TraceUnsignedBaseType_t)p_event);

#undef OS_TRACE_SEM_PEND_ENTER
#define OS_TRACE_SEM_PEND_ENTER(p_event, timeout) \
	xTraceEventCreate2(PSF_EVENT_SEM_PEND_ENTER, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)timeout);
#endif
...
#define OS_TRACE_SEM_DEL_EXIT(p_event, err) \
    if (err != OS_ERR_NONE) { \
    	xTraceEventCreate2(PSF_EVENT_SEM_DEL_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err); \
    }

#undef OS_TRACE_SEM_POST_EXIT
#define OS_TRACE_SEM_POST_EXIT(p_event, err) \
	xTraceEventCreate2(PSF_EVENT_SEM_POST_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_SEM_PEND_EXIT
#define OS_TRACE_SEM_PEND_EXIT(p_event, err) \
	xTraceEventCreate2(PSF_EVENT_SEM_PEND_EXIT, (TraceUnsignedBaseType_t)p_event, (TraceUnsignedBaseType_t)err);
#endif
