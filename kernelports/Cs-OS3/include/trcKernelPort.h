...
#define OS_TRACE_DATA_CREATE_FAILED(p_data, max_entries) \
    xTraceEventCreate2(PSF_EVENT_DATA_CREATE_FAILED, (TraceUnsignedBaseType_t)p_data, max_entries);
...
#define OS_TRACE_DATA_DEL_FAILED(p_data) \
    xTraceEventCreate1(PSF_EVENT_DATA_DELETE_FAILED, (TraceUnsignedBaseType_t)p_data);
...
#define OS_TRACE_DATA_POST(p_data, opt) \
    do { \
        if (opt & OS_OPT_POST_LIFO) { \
            xTraceEventCreate2(PSF_EVENT_DATA_POST_FRONT, (TraceUnsignedBaseType_t)p_data, (TraceUnsignedBaseType_t)(p_data->PendList.NbrEntries)); \
        } else { \
            xTraceEventCreate2(PSF_EVENT_DATA_POST, (TraceUnsignedBaseType_t)p_data, (TraceUnsignedBaseType_t)(p_data->PendList.NbrEntries)); \
        } \
    } while (0);
...
#define OS_TRACE_DATA_POST_FAILED(p_data, opt) \
    do { \
        if (opt & OS_OPT_POST_LIFO) { \
            xTraceEventCreate1(PSF_EVENT_DATA_POST_FRONT_FAILED, (TraceUnsignedBaseType_t)p_data); \
        } else { \
            xTraceEventCreate1(PSF_EVENT_DATA_POST_FAILED, (TraceUnsignedBaseType_t)p_data); \
        } \
    } while (0);
...
#define OS_TRACE_DATA_PEND(p_data) \
    xTraceEventCreate2(PSF_EVENT_DATA_PEND, (TraceUnsignedBaseType_t)p_data, (TraceUnsignedBaseType_t)(p_data->PendList.NbrEntries));

/* Called when a message is received from a data queue */
/* No need to protect critical section. */
#undef OS_TRACE_DATA_PEND_FAILED
#define OS_TRACE_DATA_PEND_FAILED(p_data) \
    xTraceEventCreate1(PSF_EVENT_DATA_PEND_FAILED, (TraceUnsignedBaseType_t)p_data);

/* Called when a message is received from a data queue */
/* No need to protect critical section. */
#undef OS_TRACE_DATA_PEND_BLOCK
#define OS_TRACE_DATA_PEND_BLOCK(p_data) \
    xTraceEventCreate2(PSF_EVENT_DATA_PEND_BLOCK, (TraceUnsignedBaseType_t)p_data, (TraceUnsignedBaseType_t)(p_data->PendList.NbrEntries));

/* Called when flushing a data queue */
/* No need to protect critical section. */
#undef OS_TRACE_DATA_FLUSH
#define OS_TRACE_DATA_FLUSH(p_data) \
    xTraceEventCreate1(PSF_EVENT_DATA_FLUSH, (TraceUnsignedBaseType_t)p_data);

/* Called when flushing a data queue */
/* No need to protect critical section. */
#undef OS_TRACE_DATA_FLUSH_FAILED
#define OS_TRACE_DATA_FLUSH_FAILED(p_data) \
    xTraceEventCreate1(PSF_EVENT_DATA_FLUSH_FAILED, (TraceUnsignedBaseType_t)p_data);

#if (OS_CFG_TRACE_API_ENTER_EN == 1u)
#undef OS_TRACE_DATA_DEL_ENTER
#define  OS_TRACE_DATA_DEL_ENTER(p_data, opt) \
    xTraceEventCreate2(PSF_EVENT_DATA_DEL_ENTER, (TraceUnsignedBaseType_t)p_data, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_DATA_POST_ENTER
#define  OS_TRACE_DATA_POST_ENTER(p_data, p_void, msg_size, opt) \
    xTraceEventCreate4(PSF_EVENT_DATA_POST_ENTER, (TraceUnsignedBaseType_t)p_data, (TraceUnsignedBaseType_t)p_void, (TraceUnsignedBaseType_t)msg_size, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_DATA_PEND_ENTER
#define  OS_TRACE_DATA_PEND_ENTER(p_data, timeout, opt, p_msg_size, item_size) \
    xTraceEventCreate5(PSF_EVENT_DATA_PEND_ENTER, (TraceUnsignedBaseType_t)p_data, (TraceUnsignedBaseType_t)timeout, (TraceUnsignedBaseType_t)opt, (TraceUnsignedBaseType_t)p_msg_size, (TraceUnsignedBaseType_t)item_size);
#endif

#if (OS_CFG_TRACE_API_EXIT_EN == 1u)
#undef OS_TRACE_DATA_DEL_EXIT
#define  OS_TRACE_DATA_DEL_EXIT(p_data, err) \
    xTraceEventCreate2(PSF_EVENT_DATA_DEL_EXIT, (TraceUnsignedBaseType_t)p_data, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_DATA_POST_EXIT
#define  OS_TRACE_DATA_POST_EXIT(p_data, err) \
    xTraceEventCreate2(PSF_EVENT_DATA_POST_EXIT, (TraceUnsignedBaseType_t)p_data, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_DATA_PEND_EXIT
#define  OS_TRACE_DATA_PEND_EXIT(p_data, err) \
    xTraceEventCreate2(PSF_EVENT_DATA_PEND_EXIT, (TraceUnsignedBaseType_t)p_data, (TraceUnsignedBaseType_t)err);
#endif
...
#define OS_TRACE_FLAG_CREATE_FAILED(p_grp, flags) \
    xTraceEventCreate2(PSF_EVENT_FLAG_CREATE_FAILED, (TraceUnsignedBaseType_t)p_grp, flags);
...
#define OS_TRACE_FLAG_DEL_FAILED(p_grp) \
    xTraceEventCreate1(PSF_EVENT_FLAG_DELETE_FAILED, (TraceUnsignedBaseType_t)p_grp);
...
#define OS_TRACE_FLAG_POST(p_grp) \
    ...
    { \
        ...
        case OS_OPT_POST_FLAG_CLR | OS_OPT_POST_NO_SCHED: \
            xTraceEventCreate1(PSF_EVENT_FLAG_POST, (TraceUnsignedBaseType_t)p_grp); \
            break; \
        default: \
            xTraceEventCreate1(PSF_EVENT_FLAG_POST_FAILED, (TraceUnsignedBaseType_t)p_grp); \
            break; \
    }
...
#define OS_TRACE_FLAG_PEND(p_grp) \
    xTraceEventCreate1(PSF_EVENT_FLAG_PEND, (TraceUnsignedBaseType_t)p_grp);

/* Called when a signal is received from a flag group */
/* No need to protect critical section. */
#undef OS_TRACE_FLAG_PEND_FAILED
#define OS_TRACE_FLAG_PEND_FAILED(p_grp) \
    xTraceEventCreate1(PSF_EVENT_FLAG_PEND_FAILED, (TraceUnsignedBaseType_t)p_grp);

/* Called when a signal is received from a flag group */
/* No need to protect critical section. */
#undef OS_TRACE_FLAG_PEND_BLOCK
#define OS_TRACE_FLAG_PEND_BLOCK(p_grp) \
    xTraceEventCreate1(PSF_EVENT_FLAG_PEND_BLOCK, (TraceUnsignedBaseType_t)p_grp);

#if (OS_CFG_TRACE_API_ENTER_EN == 1u)
#undef OS_TRACE_FLAG_DEL_ENTER
#define  OS_TRACE_FLAG_DEL_ENTER(p_grp, opt) \
    xTraceEventCreate2(PSF_EVENT_FLAG_DEL_ENTER, (TraceUnsignedBaseType_t)p_grp, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_FLAG_POST_ENTER
#define  OS_TRACE_FLAG_POST_ENTER(p_grp, flags, opt) \
    xTraceEventCreate3(PSF_EVENT_FLAG_POST_ENTER, (TraceUnsignedBaseType_t)p_grp, (TraceUnsignedBaseType_t)flags, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_FLAG_PEND_ENTER
#define  OS_TRACE_FLAG_PEND_ENTER(p_grp, flags, timeout, opt) \
    xTraceEventCreate4(PSF_EVENT_FLAG_PEND_ENTER, (TraceUnsignedBaseType_t)p_grp, (TraceUnsignedBaseType_t)flags, (TraceUnsignedBaseType_t)timeout, (TraceUnsignedBaseType_t)opt);
#endif

#if (OS_CFG_TRACE_API_EXIT_EN == 1u)
#undef OS_TRACE_FLAG_DEL_EXIT
#define  OS_TRACE_FLAG_DEL_EXIT(p_grp, err) \
    xTraceEventCreate2(PSF_EVENT_FLAG_DEL_EXIT, (TraceUnsignedBaseType_t)p_grp, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_FLAG_POST_EXIT
#define  OS_TRACE_FLAG_POST_EXIT(p_grp, err) \
    xTraceEventCreate2(PSF_EVENT_FLAG_POST_EXIT, (TraceUnsignedBaseType_t)p_grp, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_FLAG_PEND_EXIT
#define  OS_TRACE_FLAG_PEND_EXIT(p_grp, err) \
    xTraceEventCreate2(PSF_EVENT_FLAG_PEND_EXIT, (TraceUnsignedBaseType_t)p_grp, (TraceUnsignedBaseType_t)err);
#endif
...
#define OS_TRACE_MEM_CREATE(p_mem, p_name) \
    xTraceObjectRegisterWithoutHandle(PSF_EVENT_MEM_CREATE, p_mem, p_name, (TraceUnsignedBaseType_t)(p_mem->NbrMax));

/* Called from OSMemCreate. */
/* No need to protect critical section. */
#undef OS_TRACE_MEM_CREATE_FAILED
#define OS_TRACE_MEM_CREATE_FAILED(p_mem, n_blks) \
    xTraceEventCreate2(PSF_EVENT_MEM_CREATE_FAILED, (TraceUnsignedBaseType_t)p_mem, n_blks);

/* Called when a signal is sent to a memory partition */
/* No need to protect critical section. */
#undef OS_TRACE_MEM_PUT
#define OS_TRACE_MEM_PUT(p_mem) \
    xTraceEventCreate1(PSF_EVENT_MEM_PUT, (TraceUnsignedBaseType_t)p_mem);
...
#define OS_TRACE_MEM_PUT_FAILED(p_mem) \
    xTraceEventCreate1(PSF_EVENT_MEM_PUT_FAILED, (TraceUnsignedBaseType_t)p_mem);

/* Called when a signal is received from a memory partition */
/* No need to protect critical section. */
#undef OS_TRACE_MEM_GET
#define OS_TRACE_MEM_GET(p_mem) \
    xTraceEventCreate1(PSF_EVENT_MEM_GET, (TraceUnsignedBaseType_t)p_mem);

/* Called when a signal is received from a memory partition */
/* No need to protect critical section. */
#undef OS_TRACE_MEM_GET_FAILED
#define OS_TRACE_MEM_GET_FAILED(p_mem) \
    xTraceEventCreate1(PSF_EVENT_MEM_GET_FAILED, (TraceUnsignedBaseType_t)p_mem);

#if (OS_CFG_TRACE_API_ENTER_EN == 1u)
#undef OS_TRACE_MEM_PUT_ENTER
#define OS_TRACE_MEM_PUT_ENTER(p_mem, p_blk) \
    xTraceEventCreate2(PSF_EVENT_MEM_PUT_ENTER, (TraceUnsignedBaseType_t)p_mem, (TraceUnsignedBaseType_t)p_blk);

#undef OS_TRACE_MEM_GET_ENTER
#define OS_TRACE_MEM_GET_ENTER(p_mem) \
    xTraceEventCreate1(PSF_EVENT_MEM_GET_ENTER, (TraceUnsignedBaseType_t)p_mem);
#endif

#if (OS_CFG_TRACE_API_EXIT_EN == 1u)
#undef OS_TRACE_MEM_PUT_EXIT
#define OS_TRACE_MEM_PUT_EXIT(p_mem, err) \
    xTraceEventCreate2(PSF_EVENT_MEM_PUT_EXIT, (TraceUnsignedBaseType_t)p_mem, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_MEM_GET_EXIT
#define OS_TRACE_MEM_GET_EXIT(p_mem, err) \
    xTraceEventCreate2(PSF_EVENT_MEM_GET_EXIT, (TraceUnsignedBaseType_t)p_mem, (TraceUnsignedBaseType_t)err);
#endif
...
#define OS_TRACE_MUTEX_CREATE_FAILED(p_mutex) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_CREATE_FAILED, (TraceUnsignedBaseType_t)p_mutex);
...
#define OS_TRACE_MUTEX_DEL_FAILED(p_mutex) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_DELETE_FAILED, (TraceUnsignedBaseType_t)p_mutex);

/* Called when a signal is sent to a mutex */
/* No need to protect critical section. */
#undef OS_TRACE_MUTEX_POST
#define OS_TRACE_MUTEX_POST(p_mutex) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_POST, (TraceUnsignedBaseType_t)p_mutex);
...
#define OS_TRACE_MUTEX_POST_FAILED(p_mutex) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_POST_FAILED, (TraceUnsignedBaseType_t)p_mutex);

/* Called when a signal is received from a mutex */
/* No need to protect critical section. */
#undef OS_TRACE_MUTEX_PEND
#define OS_TRACE_MUTEX_PEND(p_mutex) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_PEND, (TraceUnsignedBaseType_t)p_mutex);

/* Called when a signal is received from a mutex */
/* No need to protect critical section. */
#undef OS_TRACE_MUTEX_PEND_FAILED
#define OS_TRACE_MUTEX_PEND_FAILED(p_mutex) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_PEND_FAILED, (TraceUnsignedBaseType_t)p_mutex);

/* Called when a signal is received from a mutex */
/* No need to protect critical section. */
#undef OS_TRACE_MUTEX_PEND_BLOCK
#define OS_TRACE_MUTEX_PEND_BLOCK(p_mutex) \
    xTraceEventCreate1(PSF_EVENT_MUTEX_PEND_BLOCK, (TraceUnsignedBaseType_t)p_mutex);
...
#define OS_TRACE_MUTEX_TASK_PRIO_INHERIT(p_tcb, prio) \
	xTraceEventCreate2(PSF_EVENT_TASK_PRIO_INHERIT, (TraceUnsignedBaseType_t)p_tcb, prio);
...
#define OS_TRACE_MUTEX_TASK_PRIO_DISINHERIT(p_tcb, prio) \
	xTraceEventCreate2(PSF_EVENT_TASK_PRIO_DISINHERIT, (TraceUnsignedBaseType_t)p_tcb, prio);

#if (OS_CFG_TRACE_API_ENTER_EN == 1u)
#undef OS_TRACE_MUTEX_DEL_ENTER
#define OS_TRACE_MUTEX_DEL_ENTER(p_mutex, opt) \
	xTraceEventCreate2(PSF_EVENT_MUTEX_DEL_ENTER, (TraceUnsignedBaseType_t)p_mutex, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_MUTEX_POST_ENTER
#define OS_TRACE_MUTEX_POST_ENTER(p_mutex, opt) \
	xTraceEventCreate2(PSF_EVENT_MUTEX_POST_ENTER, (TraceUnsignedBaseType_t)p_mutex, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_MUTEX_PEND_ENTER
#define OS_TRACE_MUTEX_PEND_ENTER(p_mutex, timeout, opt) \
	xTraceEventCreate3(PSF_EVENT_MUTEX_PEND_ENTER, (TraceUnsignedBaseType_t)p_mutex, (TraceUnsignedBaseType_t)timeout, (TraceUnsignedBaseType_t)opt);
#endif

#if (OS_CFG_TRACE_API_EXIT_EN == 1u)
#undef OS_TRACE_MUTEX_DEL_EXIT
#define OS_TRACE_MUTEX_DEL_EXIT(p_mutex, err) \
	xTraceEventCreate2(PSF_EVENT_MUTEX_DEL_EXIT, (TraceUnsignedBaseType_t)p_mutex, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_MUTEX_POST_EXIT
#define OS_TRACE_MUTEX_POST_EXIT(p_mutex, err) \
	xTraceEventCreate2(PSF_EVENT_MUTEX_POST_EXIT, (TraceUnsignedBaseType_t)p_mutex, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_MUTEX_PEND_EXIT
#define OS_TRACE_MUTEX_PEND_EXIT(p_mutex, err) \
	xTraceEventCreate2(PSF_EVENT_MUTEX_PEND_EXIT, (TraceUnsignedBaseType_t)p_mutex, (TraceUnsignedBaseType_t)err);
#endif
...
#define OS_TRACE_Q_CREATE_FAILED(p_q, max_qty) \
    xTraceEventCreate2(PSF_EVENT_Q_CREATE_FAILED, (TraceUnsignedBaseType_t)p_q, max_qty);
...
#define OS_TRACE_Q_DEL_FAILED(p_q) \
    xTraceEventCreate2(PSF_EVENT_Q_DELETE_FAILED, (TraceUnsignedBaseType_t)p_q, 0);
...
#define OS_TRACE_Q_POST(p_q, opt, err)  \
    do { \
        if (opt & OS_OPT_POST_LIFO) { \
            if (err == OS_ERR_NONE) { \
                xTraceEventCreate2(PSF_EVENT_Q_POST_FRONT, (TraceUnsignedBaseType_t)p_q, (TraceUnsignedBaseType_t)(p_q->PendList.NbrEntries)); \
            } else { \
                xTraceEventCreate2(PSF_EVENT_Q_POST_FRONT_FAILED, (TraceUnsignedBaseType_t)p_q, (TraceUnsignedBaseType_t)(p_q->PendList.NbrEntries)); \
            } \
        } else { \
            if (err == OS_ERR_NONE) { \
                xTraceEventCreate2(PSF_EVENT_Q_POST, (TraceUnsignedBaseType_t)p_q, (TraceUnsignedBaseType_t)(p_q->PendList.NbrEntries)); \
            } else { \
                xTraceEventCreate2(PSF_EVENT_Q_POST_FAILED, (TraceUnsignedBaseType_t)p_q, (TraceUnsignedBaseType_t)(p_q->PendList.NbrEntries)); \
            } \
        } \
    } while (0);
...
#define OS_TRACE_Q_POST_FAILED(p_q, opt) \
    do { \
        if (opt & OS_OPT_POST_LIFO) { \
            xTraceEventCreate1(PSF_EVENT_Q_POST_FRONT_FAILED, (TraceUnsignedBaseType_t)p_q); \
        } else { \
            xTraceEventCreate1(PSF_EVENT_Q_POST_FAILED, (TraceUnsignedBaseType_t)p_q); \
        } \
    } while (0);
...
#define OS_TRACE_Q_PEND(p_q) \
    xTraceEventCreate2(PSF_EVENT_Q_PEND, (TraceUnsignedBaseType_t)p_q, (TraceUnsignedBaseType_t)(p_q->PendList.NbrEntries));

/* Called when a message is received from a queue */
/* No need to protect critical section. */
#undef OS_TRACE_Q_PEND_FAILED
#define OS_TRACE_Q_PEND_FAILED(p_q) \
    xTraceEventCreate1(PSF_EVENT_Q_PEND_FAILED, (TraceUnsignedBaseType_t)p_q);

/* Called when a message is received from a queue */
/* No need to protect critical section. */
#undef OS_TRACE_Q_PEND_BLOCK
#define OS_TRACE_Q_PEND_BLOCK(p_q) \
    xTraceEventCreate2(PSF_EVENT_Q_PEND_BLOCK, (TraceUnsignedBaseType_t)p_q, (TraceUnsignedBaseType_t)(p_q->PendList.NbrEntries));

/* Called when flushing a queue */
/* No need to protect critical section. */
#undef OS_TRACE_Q_FLUSH
#define OS_TRACE_Q_FLUSH(p_q) \
    xTraceEventCreate1(PSF_EVENT_Q_FLUSH, (TraceUnsignedBaseType_t)p_q);

/* Called when flushing a queue */
/* No need to protect critical section. */
#undef OS_TRACE_Q_FLUSH_FAILED
#define OS_TRACE_Q_FLUSH_FAILED(p_q) \
    xTraceEventCreate1(PSF_EVENT_Q_FLUSH_FAILED, (TraceUnsignedBaseType_t)p_q);

#if (OS_CFG_TRACE_API_ENTER_EN == 1u)
#undef OS_TRACE_Q_DEL_ENTER
#define OS_TRACE_Q_DEL_ENTER(p_q, opt) \
	xTraceEventCreate2(PSF_EVENT_Q_DEL_ENTER, (TraceUnsignedBaseType_t)p_q, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_Q_POST_ENTER
#define OS_TRACE_Q_POST_ENTER(p_q, p_void, msg_size, opt) \
	xTraceEventCreate4(PSF_EVENT_Q_POST_ENTER, (TraceUnsignedBaseType_t)p_q,  (TraceUnsignedBaseType_t)p_void,  (TraceUnsignedBaseType_t)msg_size, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_Q_PEND_ENTER
#define OS_TRACE_Q_PEND_ENTER(p_q, timeout, opt, p_msg_size) \
	xTraceEventCreate4(PSF_EVENT_Q_PEND_ENTER, (TraceUnsignedBaseType_t)p_q, (TraceUnsignedBaseType_t)timeout, (TraceUnsignedBaseType_t)opt, (TraceUnsignedBaseType_t)p_msg_size);
#endif

#if (OS_CFG_TRACE_API_EXIT_EN == 1u)
#undef OS_TRACE_Q_DEL_EXIT
#define OS_TRACE_Q_DEL_EXIT(p_q, err) \
	xTraceEventCreate2(PSF_EVENT_Q_DEL_EXIT, (TraceUnsignedBaseType_t)p_q, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_Q_POST_EXIT
#define OS_TRACE_Q_POST_EXIT(p_q, err) \
	xTraceEventCreate2(PSF_EVENT_Q_POST_EXIT, (TraceUnsignedBaseType_t)p_q, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_Q_PEND_EXIT
#define OS_TRACE_Q_PEND_EXIT(p_q, err) \
	xTraceEventCreate2(PSF_EVENT_Q_PEND_EXIT, (TraceUnsignedBaseType_t)p_q, (TraceUnsignedBaseType_t)err);
#endif
...
#define OS_TRACE_SEM_CREATE_FAILED(p_sem, cnt) \
    xTraceEventCreate2(PSF_EVENT_SEM_CREATE_FAILED, (TraceUnsignedBaseType_t)p_sem, cnt);
...
#define OS_TRACE_SEM_DEL_FAILED(p_sem) \
    xTraceEventCreate1(PSF_EVENT_SEM_DELETE_FAILED, (TraceUnsignedBaseType_t)p_sem);
...
#define OS_TRACE_SEM_POST(p_sem) \
    ...
    { \
        xTraceEventCreate1(PSF_EVENT_SEM_POST_FAILED, (TraceUnsignedBaseType_t)p_sem); \
    } \
    else \
    { \
        xTraceEventCreate2(PSF_EVENT_SEM_POST, (TraceUnsignedBaseType_t)p_sem, (TraceUnsignedBaseType_t)(p_sem->Ctr)); \
    }
...
#define OS_TRACE_SEM_PEND(p_sem) \
    xTraceEventCreate2(PSF_EVENT_SEM_PEND, (TraceUnsignedBaseType_t)p_sem, (TraceUnsignedBaseType_t)(p_sem->Ctr));

/* Called when a message is received from a semaphore */
/* No need to protect critical section. */
#undef OS_TRACE_SEM_PEND_FAILED
#define OS_TRACE_SEM_PEND_FAILED(p_sem) \
    xTraceEventCreate1(PSF_EVENT_SEM_PEND_FAILED, (TraceUnsignedBaseType_t)p_sem);

/* Called when a message is received from a semaphore */
/* No need to protect critical section. */
#undef OS_TRACE_SEM_PEND_BLOCK
#define OS_TRACE_SEM_PEND_BLOCK(p_sem) \
    xTraceEventCreate2(PSF_EVENT_SEM_PEND_BLOCK, (TraceUnsignedBaseType_t)p_sem, (TraceUnsignedBaseType_t)(p_sem->Ctr));

/* Called setting the semaphore count */
/* No need to protect critical section. */
#undef OS_TRACE_SEM_SET
#define OS_TRACE_SEM_SET(p_sem) \
    xTraceEventCreate2(PSF_EVENT_SEM_SET, (TraceUnsignedBaseType_t)p_sem, (TraceUnsignedBaseType_t)(p_sem->Ctr));

/* Called setting the semaphore count */
/* No need to protect critical section. */
#undef OS_TRACE_SEM_SET_FAILED
#define OS_TRACE_SEM_SET_FAILED(p_sem, cnt) \
    xTraceEventCreate2(PSF_EVENT_SEM_SET_FAILED, (TraceUnsignedBaseType_t)p_sem, cnt);

#if (OS_CFG_TRACE_API_ENTER_EN == 1u)
#undef OS_TRACE_SEM_DEL_ENTER
#define OS_TRACE_SEM_DEL_ENTER(p_sem, opt) \
	xTraceEventCreate2(PSF_EVENT_SEM_DEL_ENTER, (TraceUnsignedBaseType_t)p_sem, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_SEM_POST_ENTER
#define OS_TRACE_SEM_POST_ENTER(p_sem, opt) \
	xTraceEventCreate2(PSF_EVENT_SEM_POST_ENTER, (TraceUnsignedBaseType_t)p_sem, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_SEM_PEND_ENTER
#define OS_TRACE_SEM_PEND_ENTER(p_sem, timeout, opt) \
	xTraceEventCreate3(PSF_EVENT_SEM_PEND_ENTER, (TraceUnsignedBaseType_t)p_sem, (TraceUnsignedBaseType_t)timeout, (TraceUnsignedBaseType_t)opt);
#endif

#if (OS_CFG_TRACE_API_EXIT_EN == 1u)
#undef OS_TRACE_SEM_DEL_EXIT
#define OS_TRACE_SEM_DEL_EXIT(p_sem, err) \
	xTraceEventCreate2(PSF_EVENT_SEM_DEL_EXIT, (TraceUnsignedBaseType_t)p_sem, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_SEM_POST_EXIT
#define OS_TRACE_SEM_POST_EXIT(p_sem, err) \
	xTraceEventCreate2(PSF_EVENT_SEM_POST_EXIT, (TraceUnsignedBaseType_t)p_sem, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_SEM_PEND_EXIT
#define OS_TRACE_SEM_PEND_EXIT(p_sem, err) \
	xTraceEventCreate2(PSF_EVENT_SEM_PEND_EXIT, (TraceUnsignedBaseType_t)p_sem, (TraceUnsignedBaseType_t)err);
#endif
...
#define OS_TRACE_TASK_CREATE_FAILED(p_tcb, prio) \
    xTraceEventCreate2(PSF_EVENT_TASK_CREATE_FAILED, (TraceUnsignedBaseType_t)p_tcb, prio);
...
#define OS_TRACE_TASK_DLY(p_tcb, dly_ticks) \
    xTraceEventCreate2(PSF_EVENT_TASK_DELAY, (TraceUnsignedBaseType_t)p_tcb, dly_ticks);

/* Called on OSTaskSuspend() */
/* No need to protect critical section. */
#undef OS_TRACE_TASK_SUSPEND
#define OS_TRACE_TASK_SUSPEND(p_tcb) \
    xTraceEventCreate1(PSF_EVENT_TASK_SUSPEND, (TraceUnsignedBaseType_t)p_tcb);
...
#define OS_TRACE_TASK_SUSPEND_FAILED(p_tcb) \
    if (p_tcb == 0) { \
        xTraceEventCreate1(PSF_EVENT_TASK_SUSPEND_FAILED, (TraceUnsignedBaseType_t)OSTCBCurPtr); \
    } else { \
        xTraceEventCreate1(PSF_EVENT_TASK_SUSPEND_FAILED, (TraceUnsignedBaseType_t)p_tcb); \
    }
...
#define OS_TRACE_TASK_RESUME(p_tcb) \
    xTraceEventCreate1(PSF_EVENT_TASK_RESUME, (TraceUnsignedBaseType_t)p_tcb);

/* Called on OSTaskResume() */
/* No need to protect critical section. */
#undef OS_TRACE_TASK_RESUME_FAILED
#define OS_TRACE_TASK_RESUME_FAILED(p_tcb) \
    xTraceEventCreate1(PSF_EVENT_TASK_RESUME_FAILED, (TraceUnsignedBaseType_t)p_tcb);
...
#define OS_TRACE_TASK_Q_CREATE(p_tcb, p_name) \
    do { \
        ...
        if (p_tcb) \
        { \
            xTraceEventCreate2(PSF_EVENT_TASK_Q_CREATE, (TraceUnsignedBaseType_t)&p_tcb->MsgQ, (TraceUnsignedBaseType_t)p_tcb->MsgQ.NbrEntries); \
...
#define OS_TRACE_TASK_Q_DEL(p_tcb) \
    xTraceObjectUnregisterWithoutHandle(PSF_EVENT_TASK_Q_DELETE, (void *)&p_tcb->MsgQ, (TraceUnsignedBaseType_t)p_tcb->MsgQ.NbrEntries);
...
#define OS_TRACE_TASK_Q_POST(p_tcb, opt, err) \
    do { \
        if (opt & OS_OPT_POST_LIFO) { \
            if (err == OS_ERR_NONE) { \
                xTraceEventCreate2(PSF_EVENT_TASK_Q_POST_FRONT, (TraceUnsignedBaseType_t)&p_tcb->MsgQ, (TraceUnsignedBaseType_t)p_tcb->MsgQ.NbrEntries); \
            } else { \
                xTraceEventCreate1(PSF_EVENT_TASK_Q_POST_FRONT_FAILED, (TraceUnsignedBaseType_t)&p_tcb->MsgQ); \
            } \
        } else { \
            if (err == OS_ERR_NONE) { \
                xTraceEventCreate2(PSF_EVENT_TASK_Q_POST, (TraceUnsignedBaseType_t)&p_tcb->MsgQ, (TraceUnsignedBaseType_t)p_tcb->MsgQ.NbrEntries); \
            } else { \
                xTraceEventCreate1(PSF_EVENT_TASK_Q_POST_FAILED, (TraceUnsignedBaseType_t)&p_tcb->MsgQ); \
            } \
        } \
    } while (0);
...
#define OS_TRACE_TASK_Q_POST_FAILED(p_tcb, opt) \
    do { \
        if (opt & OS_OPT_POST_LIFO) { \
            if (p_tcb == 0) { \
                xTraceEventCreate1(PSF_EVENT_TASK_Q_POST_FRONT_FAILED, (TraceUnsignedBaseType_t)&OSTCBCurPtr->MsgQ); \
            } else { \
                xTraceEventCreate1(PSF_EVENT_TASK_Q_POST_FRONT_FAILED, (TraceUnsignedBaseType_t)&p_tcb->MsgQ); \
            } \
        } else { \
            if (p_tcb == 0) { \
                xTraceEventCreate1(PSF_EVENT_TASK_Q_POST_FAILED, (TraceUnsignedBaseType_t)&OSTCBCurPtr->MsgQ); \
            } else { \
                xTraceEventCreate1(PSF_EVENT_TASK_Q_POST_FAILED, (TraceUnsignedBaseType_t)&p_tcb->MsgQ); \
            } \
        } \
...
#define OS_TRACE_TASK_Q_PEND(p_tcb) \
    xTraceEventCreate2(PSF_EVENT_TASK_Q_PEND, (TraceUnsignedBaseType_t)&p_tcb->MsgQ, (TraceUnsignedBaseType_t)p_tcb->MsgQ.NbrEntries);

/* Called when a message is received from a task message queue */
/* No need to protect critical section. */
#undef OS_TRACE_TASK_Q_PEND_FAILED
#define OS_TRACE_TASK_Q_PEND_FAILED(p_tcb) \
    xTraceEventCreate1(PSF_EVENT_TASK_Q_PEND_FAILED, (TraceUnsignedBaseType_t)&p_tcb->MsgQ);

/* Called when a message is received from a task message queue */
/* No need to protect critical section. */
#undef OS_TRACE_TASK_Q_PEND_BLOCK
#define OS_TRACE_TASK_Q_PEND_BLOCK(p_tcb) \
    xTraceEventCreate2(PSF_EVENT_TASK_Q_PEND_BLOCK, (TraceUnsignedBaseType_t)&p_tcb->MsgQ, (TraceUnsignedBaseType_t)p_tcb->MsgQ.NbrEntries);

/* Called when flushing a task message queue */
/* No need to protect critical section. */
#undef OS_TRACE_TASK_Q_FLUSH
#define OS_TRACE_TASK_Q_FLUSH(p_tcb) \
    xTraceEventCreate1(PSF_EVENT_TASK_Q_FLUSH, (TraceUnsignedBaseType_t)&p_tcb->MsgQ);
...
#define OS_TRACE_TASK_Q_FLUSH_FAILED(p_tcb) \
    if (p_tcb == 0) { \
        xTraceEventCreate1(PSF_EVENT_TASK_Q_FLUSH_FAILED, (TraceUnsignedBaseType_t)&OSTCBCurPtr->MsgQ); \
    } else { \
        xTraceEventCreate1(PSF_EVENT_TASK_Q_FLUSH_FAILED, (TraceUnsignedBaseType_t)&p_tcb->MsgQ); \
    }
...
#define OS_TRACE_TASK_SEM_CREATE(p_tcb, p_name) \
    do { \
        ...
        if (p_tcb) \
        { \
            xTraceEventCreate2(PSF_EVENT_TASK_SEM_CREATE, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr), p_tcb->SemCtr); \
...
#define OS_TRACE_TASK_SEM_POST(p_tcb) \
    xTraceEventCreate2(PSF_EVENT_TASK_SEM_POST, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr), (TraceUnsignedBaseType_t)(p_tcb->SemCtr));
...
#define OS_TRACE_TASK_SEM_POST_FAILED(p_tcb) \
    if (p_tcb == 0) { \
        xTraceEventCreate1(PSF_EVENT_TASK_SEM_POST_FAILED, (TraceUnsignedBaseType_t)(&OSTCBCurPtr->SemCtr)); \
    } else { \
        xTraceEventCreate1(PSF_EVENT_TASK_SEM_POST_FAILED, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr)); \
    }
...
#define OS_TRACE_TASK_SEM_PEND(p_tcb) \
    xTraceEventCreate2(PSF_EVENT_TASK_SEM_PEND, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr), (TraceUnsignedBaseType_t)(p_tcb->SemCtr));

/* Called when a message is received from a task semaphore */
/* No need to protect critical section. */
#undef OS_TRACE_TASK_SEM_PEND_FAILED
#define OS_TRACE_TASK_SEM_PEND_FAILED(p_tcb) \
    xTraceEventCreate1(PSF_EVENT_TASK_SEM_PEND_FAILED, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr));

/* Called when a message is received from a task semaphore */
/* No need to protect critical section. */
#undef OS_TRACE_TASK_SEM_PEND_BLOCK
#define OS_TRACE_TASK_SEM_PEND_BLOCK(p_tcb) \
    xTraceEventCreate2(PSF_EVENT_TASK_SEM_PEND_BLOCK, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr), (TraceUnsignedBaseType_t)(p_tcb->SemCtr));

/* Called when setting a Task Sem's count */
#undef OS_TRACE_TASK_SEM_SET
#define OS_TRACE_TASK_SEM_SET(p_tcb) \
    xTraceEventCreate2(PSF_EVENT_TASK_SEM_SET, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr), (TraceUnsignedBaseType_t)(p_tcb->SemCtr));

/* Called when setting a Task Sem's count */
#undef OS_TRACE_TASK_SEM_SET_FAILED
#define OS_TRACE_TASK_SEM_SET_FAILED(p_tcb, cnt) \
    if (p_tcb == 0) { \
        xTraceEventCreate2(PSF_EVENT_TASK_SEM_SET_FAILED, (TraceUnsignedBaseType_t)(&OSTCBCurPtr->SemCtr), cnt); \
    } else { \
        xTraceEventCreate2(PSF_EVENT_TASK_SEM_SET_FAILED, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr), cnt); \
    }

#if (OS_CFG_TRACE_API_ENTER_EN == 1u)
#undef OS_TRACE_TASK_Q_PEND_ENTER
#define OS_TRACE_TASK_Q_PEND_ENTER(p_tcb, timeout, opt, p_msg_size) \
	xTraceEventCreate4(PSF_EVENT_TASK_Q_PEND_ENTER, (TraceUnsignedBaseType_t)&p_tcb->MsgQ, (TraceUnsignedBaseType_t)timeout, (TraceUnsignedBaseType_t)opt, (TraceUnsignedBaseType_t)p_msg_size);

#undef OS_TRACE_TASK_Q_POST_ENTER
#define OS_TRACE_TASK_Q_POST_ENTER(p_tcb, p_void, msg_size, opt) \
    if (p_tcb == 0) { \
        xTraceEventCreate4(PSF_EVENT_TASK_Q_POST_ENTER, (TraceUnsignedBaseType_t)&OSTCBCurPtr->MsgQ, (TraceUnsignedBaseType_t)p_void, (TraceUnsignedBaseType_t)msg_size, (TraceUnsignedBaseType_t)opt); \
    } else { \
        xTraceEventCreate4(PSF_EVENT_TASK_Q_POST_ENTER, (TraceUnsignedBaseType_t)&p_tcb->MsgQ, (TraceUnsignedBaseType_t)p_void, (TraceUnsignedBaseType_t)msg_size, (TraceUnsignedBaseType_t)opt); \
    }

#undef OS_TRACE_TASK_SEM_PEND_ENTER
#define OS_TRACE_TASK_SEM_PEND_ENTER(p_tcb, timeout, opt) \
	xTraceEventCreate3(PSF_EVENT_TASK_SEM_PEND_ENTER, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr), (TraceUnsignedBaseType_t)timeout, (TraceUnsignedBaseType_t)opt);

#undef OS_TRACE_TASK_SEM_POST_ENTER
#define OS_TRACE_TASK_SEM_POST_ENTER(p_tcb, opt) \
    if (p_tcb == 0) { \
        xTraceEventCreate2(PSF_EVENT_TASK_SEM_POST_ENTER, (TraceUnsignedBaseType_t)(&OSTCBCurPtr->SemCtr), (TraceUnsignedBaseType_t)opt); \
    } else { \
        xTraceEventCreate2(PSF_EVENT_TASK_SEM_POST_ENTER, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr), (TraceUnsignedBaseType_t)opt); \
    }

#undef OS_TRACE_TASK_SUSPEND_ENTER
#define OS_TRACE_TASK_SUSPEND_ENTER(p_tcb) \
    if (p_tcb == 0) { \
        xTraceEventCreate1(PSF_EVENT_TASK_SUSPEND_ENTER, (TraceUnsignedBaseType_t)OSTCBCurPtr); \
    } else { \
        xTraceEventCreate1(PSF_EVENT_TASK_SUSPEND_ENTER, (TraceUnsignedBaseType_t)p_tcb); \
    }

#undef OS_TRACE_TASK_RESUME_ENTER
#define OS_TRACE_TASK_RESUME_ENTER(p_tcb) \
	xTraceEventCreate1(PSF_EVENT_TASK_RESUME_ENTER, (TraceUnsignedBaseType_t)p_tcb);
#endif

#if (OS_CFG_TRACE_API_EXIT_EN == 1u)
#undef OS_TRACE_TASK_Q_PEND_EXIT
#define OS_TRACE_TASK_Q_PEND_EXIT(p_tcb, err) \
    xTraceEventCreate2(PSF_EVENT_TASK_Q_PEND_EXIT, (TraceUnsignedBaseType_t)&p_tcb->MsgQ, (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_TASK_Q_POST_EXIT
#define OS_TRACE_TASK_Q_POST_EXIT(p_tcb, err) \
    if (p_tcb == 0) { \
        xTraceEventCreate2(PSF_EVENT_TASK_Q_POST_EXIT, (TraceUnsignedBaseType_t)&OSTCBCurPtr->MsgQ, (TraceUnsignedBaseType_t)err); \
    } else { \
        xTraceEventCreate2(PSF_EVENT_TASK_Q_POST_EXIT, (TraceUnsignedBaseType_t)&p_tcb->MsgQ, (TraceUnsignedBaseType_t)err); \
    }

#undef OS_TRACE_TASK_SEM_PEND_EXIT
#define OS_TRACE_TASK_SEM_PEND_EXIT(p_tcb, err) \
	xTraceEventCreate2(PSF_EVENT_TASK_SEM_PEND_EXIT, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr), (TraceUnsignedBaseType_t)err);

#undef OS_TRACE_TASK_SEM_POST_EXIT
#define OS_TRACE_TASK_SEM_POST_EXIT(p_tcb, err) \
    if (p_tcb == 0) { \
        xTraceEventCreate2(PSF_EVENT_TASK_SEM_POST_EXIT, (TraceUnsignedBaseType_t)(&OSTCBCurPtr->SemCtr), (TraceUnsignedBaseType_t)err); \
    } else { \
        xTraceEventCreate2(PSF_EVENT_TASK_SEM_POST_EXIT, (TraceUnsignedBaseType_t)(&p_tcb->SemCtr), (TraceUnsignedBaseType_t)err); \
    }

#undef OS_TRACE_TASK_SUSPEND_EXIT
#define OS_TRACE_TASK_SUSPEND_EXIT(p_tcb, err) \
    if (p_tcb == 0) { \
        xTraceEventCreate2(PSF_EVENT_TASK_SUSPEND_EXIT, (TraceUnsignedBaseType_t)OSTCBCurPtr, (TraceUnsignedBaseType_t)err); \
    } else { \
        xTraceEventCreate2(PSF_EVENT_TASK_SUSPEND_EXIT, (TraceUnsignedBaseType_t)p_tcb, (TraceUnsignedBaseType_t)err); \
    }

#undef OS_TRACE_TASK_RESUME_EXIT
#define OS_TRACE_TASK_RESUME_EXIT(p_tcb, err) \
    xTraceEventCreate2(PSF_EVENT_TASK_RESUME_EXIT, (TraceUnsignedBaseType_t)p_tcb, (TraceUnsignedBaseType_t)err);
#endif
...
#define  OS_TRACE_TMR_CREATE_FAILED(p_tmr, dly, period) \
    xTraceEventCreate3(PSF_EVENT_TMR_CREATE_FAILED, (TraceUnsignedBaseType_t)p_tmr, dly, period);
...
#define  OS_TRACE_TMR_EXPIRED(p_tmr) \
    xTraceEventCreate1(PSF_EVENT_TMR_EXPIRED, (TraceUnsignedBaseType_t)p_tmr);

#undef OS_TRACE_TMR_DEL_ENTER
#define OS_TRACE_TMR_DEL_ENTER(p_tmr) \
    xTraceEventCreate1(PSF_EVENT_TMR_DEL_ENTER, (TraceUnsignedBaseType_t)p_tmr);

#undef OS_TRACE_TMR_DEL_EXIT
#define OS_TRACE_TMR_DEL_EXIT(p_tmr, err) \
    xTraceEventCreate2(PSF_EVENT_TMR_DEL_EXIT, (TraceUnsignedBaseType_t)p_tmr, (TraceUnsignedBaseType_t)err);
